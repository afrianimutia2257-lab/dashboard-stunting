...
# -------------------------
with tab1:
    st.title("📊 Dashboard Stunting Indonesia")
...
# -------------------------
with tab2:
    st.header("📊 Statistik Deskriptif Variabel Utama")
...
# -------------------------
with tab3:
    st.header("📈 Visualisasi Variabel Utama dengan Filter")
...
# -------------------------
with tab4:
    st.header("🔍 Analisis Perbandingan Antar Kelompok (Jenis Kelamin)")
...
# -------------------------
with tab5:
    st.header("🔥 Heatmap Korelasi Variabel Utama")
    corr_cols = ["I05A", "I07"]
